...
public class SolAccesoEquipo {
    ...
    @Column(name = "motivo_integracion", columnDefinition = "TEXT", nullable = false)
    ...
    /** Equipo al que se solicita acceso */
    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "idEquipo_destino", nullable = false)
    ...
    /** Usuario que revisa (PO / Admin / Líder de equipo) */
    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "idUsuario_revisor", nullable = false)
