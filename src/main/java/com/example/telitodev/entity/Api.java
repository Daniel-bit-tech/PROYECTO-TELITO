...
public class Api {
    ...
    // CAMBIO PRINCIPAL: Usuario → Equipo
    @ManyToOne
    @JoinColumn(name = "idEquipo", nullable = false)  // Cambiado de idUsuario a idEquipo
    private Equipo equipo;  // Cambiado de Usuario a Equipo
    ...
    public Api(String nombre, String descripcion, Timestamp fechaCreacion,
               Dominio dominio, Tag tag, Equipo equipo, String endpointUrl) {  // Cambiado
        this.nombre = nombre;
        this.descripcion = descripcion;
        this.fechaCreacion = fechaCreacion;
        this.dominio = dominio;
        this.tag = tag;
        this.equipo = equipo;  // Cambiado
    ...
    // ELIMINAR o COMENTAR los métodos getUsuario/setUsuario
    /*
