...
public class PerfilController {
    ...
    private Usuario obtenerUsuarioActual(Authentication auth, HttpSession session) {
        ...
        if (isImpersonating != null && isImpersonating) {
            ...
            if (impersonatedUserDni != null) {
                ...
                if (impersonatedUser != null) {
                    System.out.println("🎭 Perfil DEV - Usando datos del usuario impersonado: " + impersonatedUser.getNombre());
        ...
        System.out.println("👤 Perfil DEV - Usando datos del usuario autenticado: " + usuario.getNombre());
        return usuario;
    }
