...
public class KPIsController {
    ...
    private Usuario obtenerUsuarioActual(Authentication auth, HttpSession session) {
        ...
        if (isImpersonating != null && isImpersonating) {
            ...
            if (impersonatedUserDni != null) {
                ...
                if (impersonatedUser != null) {
                    System.out.println("🎭 KPIs - Usando datos del usuario impersonado: " + impersonatedUser.getNombre());
        ...
        System.out.println("👤 KPIs - Usando datos del usuario autenticado: " + usuario.getNombre());
        return usuario;
    }
