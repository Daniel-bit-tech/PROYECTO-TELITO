...
public class AdminSolicitudesController extends BaseController {
    ...
    public String mostrarSolicitudes(Model model, Authentication authentication, HttpSession session) {
        try {
            ...
            List<SolAccesoEquipo> solicitudesOrganizacion = solAccesoOrgService.obtenerSolicitudesPendientes();
            ...
            long totalOrgAprobadas = solAccesoOrgService.contarSolicitudesPorEstado(SolAccesoEquipo.EstadoSolicitud.APROBADA);
            long totalOrgRechazadas = solAccesoOrgService.contarSolicitudesPorEstado(SolAccesoEquipo.EstadoSolicitud.RECHAZADA);
    ...
    public ResponseEntity<Map<String, Object>> obtenerEstadisticas() {
        try {
            ...
            statsOrg.put("pendientes", solAccesoOrgService.contarSolicitudesPorEstado(SolAccesoEquipo.EstadoSolicitud.PENDIENTE));
            statsOrg.put("aprobadas", solAccesoOrgService.contarSolicitudesPorEstado(SolAccesoEquipo.EstadoSolicitud.APROBADA));
            statsOrg.put("rechazadas", solAccesoOrgService.contarSolicitudesPorEstado(SolAccesoEquipo.EstadoSolicitud.RECHAZADA));
